Translation = {
    ...
    Romanian = {
        ...
        MessageOfSystem = {
			...
			TitleOnDead        = "Scrie /alertdoctor in chat pentru a solicita ajutorul medicului", -- Ai nevoie de un script pentru aceasta, este doar un exemplu
